...
# Debian-based (glibc) image. The Alpine/musl image produced a broken
# server-side React render of the Payload admin (blank screen) for this
# Next.js 15.4 / Payload 3.85 combination; glibc renders correctly.
